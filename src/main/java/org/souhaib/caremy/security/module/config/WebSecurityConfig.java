...
import org.souhaib.caremy.security.module.security.auth.RestAuthenticationEntryPoint;
import org.souhaib.caremy.security.module.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(SecurityParams.SOCKET_MODULE_URL+"/**").permitAll()
